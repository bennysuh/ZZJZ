...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"此項必須填寫",invalidMessage:null,rules:{email:{validator:function(_362){
...
},message:"請輸入有效的電郵地址"},url:{validator:function(_363){
...
return _6d1(jq[0]);
},getValueX:function(jq){
return $.data(jq[0],"combo").combo.find(".combo-text").val();
...
if(_711){
$.extend(true,_711.options,_70e);
_70c(this);
}else{
_711=$.data(this,"combobox",{options:$.extend(true,{},$.fn.combobox.defaults,$.fn.combobox.parseOptions(this),_70e)});
_70c(this);
_700(this,_6fe(this));
}
