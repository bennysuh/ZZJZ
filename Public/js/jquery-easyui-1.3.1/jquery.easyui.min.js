...
var item=_751.find("div.combobox-item[value=\""+_750.replace(/'/g, "\\'")+"\"]");
if(item.length){
...
var item=_754.find("div.combobox-item[value=\""+_755.pop().replace(/'/g, "\\'")+"\"]");
if(item.length){
...
var item=_75a.find("div.combobox-item[value=\""+_75b.pop().replace(/'/g, "\\'")+"\"]");
if(item.length){
...
vv.push(v);
ss.push(s);
_768.find("div.combobox-item[value=\""+v.replace(/'/g, "\\'")+"\"]").addClass("combobox-item-selected");
}
...
var v=data[i][opts.valueField];
var s=data[i][opts.textField];
var item=_776.find("div.combobox-item[value=\""+v.replace(/'/g, "\\'")+"\"]");
item.show();
if(s==q){
_760(_775,[v],true);
