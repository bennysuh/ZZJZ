...
(function($) {
		...
		return this.each(function() {
			...
			if (_1f) {
				...
				$.data(this, "validatebox", {
					options : $.extend({}, $.fn.validatebox.defaults, $.fn.validatebox.parseOptions(this), _1d)
				});
			}
			_7(this);
		});
	...
	$.fn.validatebox.parseOptions = function(_20) {
		var t = $(_20);
		return $.extend({}, $.parser.parseOptions(_20, ["validType", "missingMessage", "invalidMessage"]), {
