...
// +----------------------------------------------------------------------
// $Id$
class StaffViewModel extends Model {
	/**
     +----------------------------------------------------------
    * portal分组 
     +----------------------------------------------------------
    ...
    */
	public $viewFields = array(
		'zz_staff' => array('staffid', 'name', 'whcd', 'ygbh','gzjy','jg_province','jg_city','birthday','tc','languages','address','images','remark','updatetime'),
